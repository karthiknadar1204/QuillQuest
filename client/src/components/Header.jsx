    ...
    <Navbar className="border-b-2 bg-[#1F2937]">
      ...
      <Navbar.Collapse>
        <Navbar.Link
          active={path === "/"}
          as={"div"}
          className="text-xl mx-4 architects-daughter"
        >
          <Link to="/">Home</Link>
        </Navbar.Link>
        <Navbar.Link
        ...
        <Navbar.Link
          ...
          className="text-xl mx-4 architects-daughter"
        >
          <Link to="/create-post">Post Likh Behenchod</Link>
        </Navbar.Link>
      </Navbar.Collapse>
    </Navbar>
  );
